...
router.get('/cliente/:cnpj', auth, clientesController.getByCNPJ);
...
router.delete('/cliente-remove/:id', auth, clientesController.delete);

// CRUD Motoboy
router.get('/motoboys/list', auth, motoboysController.list);
router.get('/motoboys/:cpf', auth, motoboysController.find);
...
router.get('/entregas/:motoboyId', auth, entregasController.findByMotoboy);
